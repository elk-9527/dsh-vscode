### REPO: plastic-labs/dsh-honcho  SUBDIR:   BRANCH: 
ATOM OK branch=main
COMMIT 2026-09-02T18:01:05Z :: chore: commit the runtime entry so git-tree catalogs can resolve it (#2)
COMMIT 2026-09-02T15:00:36Z :: chore: update package.json to indicate public access
COMMIT 2026-09-02T13:40:42Z :: fix: return a CommandResult from /honcho so dsh's registry accepts it…
COMMIT 2026-09-01T04:31:34Z :: fix: deliver memory on the first request, and stop stale config keys …
COMMIT 2026-09-01T04:22:46Z :: refactor: drop config keys that did nothing, report the rest
=== README FROM: https://raw.githubusercontent.com/plastic-labs/dsh-honcho/main/README.md (len=9045) ===
# dsh-honcho
