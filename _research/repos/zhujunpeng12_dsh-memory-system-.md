### REPO: zhujunpeng12/dsh-memory-system  SUBDIR:   BRANCH: 
META default_branch=master stars=8 forks=0 pushed_at=2026-08-21T03:05:38Z created_at=2026-08-15T05:24:06Z license=MIT archived=False open_issues=0 homepage=
META description=Local-first persistent memory infrastructure for DeepSeek Harness: hot bootstrap, Chinese-BM25 cold recall, lease-lock transactional writes, read-only governance
RELEASE v0.1.1 published=2026-08-21T02:59:38Z prerelease=False assets=1
COMMIT 71d48bd 2026-08-21T03:05:33Z :: chore: optimize GitHub social preview
COMMIT f9aa09e 2026-08-21T02:57:44Z :: fix: restore plugin installability and publish V3 architecture
COMMIT 02652ab 2026-08-21T02:56:07Z :: docs: update memory architecture diagram to v3
TREE FILECOUNT=93
...
F docs/memory-system-flowchart.html
F docs/memory-system-flowchart.png
F dsh.plugin.json
F hooks.example.json
F index.js
F package.json
F plugins/agent-teams/.gitignore
F plugins/agent-teams/.npmrc
F plugins/agent-teams/LICENSE
F plugins/agent-teams/README.md
F plugins/agent-teams/cordis.patch.yml
F plugins/agent-teams/package.json
F plugins/agent-teams/src/client/ActivityPanel.module.css
F plugins/agent-teams/src/client/ActivityPanel.tsx
F plugins/agent-teams/src/client/AgentTeamsCard.module.css
F plugins/agent-teams/src/client/AgentTeamsCard.tsx
F plugins/agent-teams/src/client/activity-model.ts
F plugins/agent-teams/src/client/agent-teams-card-definition.ts
F plugins/agent-teams/src/client/artwork.ts
F plugins/agent-teams/src/client/index.tsx
F plugins/agent-teams/src/css-modules.d.ts
F plugins/agent-teams/src/event-types.ts
F plugins/agent-teams/src/events.ts
F plugins/agent-teams/src/index.ts
F plugins/agent-teams/src/members.ts
F plugins/agent-teams/src/snapshot.ts
F plugins/agent-teams/src/state.ts
F plugins/agent-teams/src/tools.ts
F plugins/agent-teams/src/types.ts
F plugins/agent-teams/tsconfig.client.json
F plugins/agent-teams/tsconfig.json
F plugins/agent-teams/tsdown.config.ts
F plugins/evidence-ledger/README.md
F plugins/evidence-ledger/backfill.py
F plugins/evidence-ledger/cordis.patch.yml
F plugins/evidence-ledger/index.js
F plugins/evidence-ledger/package.json
F plugins/evidence-ledger/report.py
F plugins/evidence-ledger/test-attribution.mjs
F plugins/evidence-ledger/toolmap.json
F templates/README.md
F templates/vault/memory/events/.gitkeep.md
F templates/vault/memory/index/.gitkeep.md
F templates/vault/memory/rules.example.md
F templates/vault/memory/user_profile.example.md
F templates/vault/projects/.gitkeep.md
F test_manifest_contract.test.mjs
F test_package_smoke.test.mjs
F test_plugin_bridge.test.mjs
F vault-guard/README.md
F vault-guard/bootstrap.py
F vault-guard/check.py
F vault-guard/govern.py
F vault-guard/hook-first-prompt.py
F vault-guard/hook-session-start.py
F vault-guard/recall.py
F vault-guard/recall_trigger.py
F vault-guard/rule-cite.py
F vault-guard/rules_core.py
F vault-guard/sync-core.py
F vault-guard/test_bootstrap.py
F vault-guard/test_govern.py
F vault-guard/test_hook_first_prompt.py
F vault-guard/test_memory_tools.py
F vault-guard/test_memory_v3.py
F vault-guard/test_recall.py
F vault-guard/trajectory-review.py
F vault-guard/vault-lock.py
F vault-guard/vault-probe.py
F vault-guard/vault-write.py
F vault-guard/vault_lock.py
F vault-guard/vault_path.py
F vault-guard/vault_tx.py
=== README FROM: https://raw.githubusercontent.com/zhujunpeng12/dsh-memory-system/master/README.md (len=13661) ===
<p align="center">
