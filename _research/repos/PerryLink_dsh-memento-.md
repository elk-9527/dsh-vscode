### REPO: PerryLink/dsh-memento  SUBDIR:   BRANCH: 
META default_branch=main stars=96 forks=3 pushed_at=2026-09-16T02:27:32Z created_at=2026-08-13T19:29:14Z license=Apache-2.0 archived=False open_issues=2 homepage=https://www.npmjs.com/package/dsh-memento
META description=Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provider + memory tool + frozen snapshot injection)
RELEASE v0.5.12 published=2026-09-12T02:31:28Z prerelease=False assets=0
RELEASE v0.5.11 published=2026-09-10T06:42:29Z prerelease=False assets=0
RELEASE v0.5.10 published=2026-09-09T14:58:05Z prerelease=False assets=0
COMMIT 3bc40a0 2026-09-15T17:30:29Z :: chore(lock): sync the package-lock version field with 0.5.12
COMMIT 3fcd08a 2026-09-12T09:32:36Z :: docs(readme): refresh the five-language docs and the family roster
COMMIT 2fc2d80 2026-09-12T02:25:28Z :: chore(release): 0.5.12
TREE FILECOUNT=88
...
F .github/workflows/compat.yml
F .github/workflows/plugin-doctor.yml
F .github/workflows/release.yml
F .github/workflows/scorecard.yml
F .gitignore
F AGENTS.md
F ARCHITECTURE.md
F CHANGELOG.md
...
F bin/mcp-server.mjs
F client/client.d.ts
F client/client.js
F cordis.patch.yml
F docs/OMDSH_REVIEW.md
F docs/adapters-guide.md
F docs/adapters-guide.zh.md
F docs/protocol-v1.md
F docs/protocol-v1.zh.md
F docs/schemas/dsh-memory-protocol-v1.schema.json
F docs/upstream-proposal.md
F docs/upstream-proposal.zh.md
F index.mjs
F lib/adapters.mjs
F lib/budget.mjs
F lib/constants.mjs
...
F renovate.json5
F scripts/changelog-section.mjs
F scripts/check-coverage.mjs
F scripts/loader-runner.mjs
F scripts/verify-artifacts.mjs
F scripts/verify-readmes.mjs
F scripts/verify-self-contained.mjs
F test/adapters.test.mjs
F test/budget.test.mjs
F test/composition.test.mjs
F test/coverage-report.test.mjs
F test/embedding.test.mjs
F test/extract.test.mjs
F test/fixtures.test.mjs
F test/fixtures/mock-webserver.mjs
F test/gate.test.mjs
F test/helpers/fixtures.mjs
F test/helpers/mock-ctx.mjs
F test/index.test.mjs
F test/lifecycle.test.mjs
F test/match.test.mjs
F test/mcp.test.mjs
F test/proposals.test.mjs
F test/protocol-conformance.test.mjs
F test/protocol-conformance/README.md
F test/protocol-conformance/golden.mjs
F test/protocol-conformance/run.mjs
F test/protocol-conformance/suite.mjs
F test/retrieval.test.mjs
F test/settings.test.mjs
F test/snapshot.test.mjs
F test/store.test.mjs
F test/v2.test.mjs
F tsconfig.check.json
F types.d.ts
=== README FROM: https://raw.githubusercontent.com/PerryLink/dsh-memento/main/README.md (len=25452) ===
<div align="center">
