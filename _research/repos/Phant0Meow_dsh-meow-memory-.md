### REPO: Phant0Meow/dsh-meow-memory  SUBDIR:   BRANCH: 
META default_branch=main stars=104 forks=9 pushed_at=2026-09-10T19:37:59Z created_at=2026-08-14T08:54:33Z license=MIT archived=False open_issues=5 homepage=
META description=Cross-session memory plugin for DeepSeek Harness: seven-layer SQLite store (soul/user/project/fact/lesson/topic/rules), BM25 retrieval, per-window dream consolidation. 跨会话七层长期记忆插件。
RELEASE v0.25.1 published=2026-09-10T14:40:20Z prerelease=False assets=0
RELEASE v0.25.0 published=2026-09-10T13:05:46Z prerelease=False assets=0
RELEASE v0.24.1 published=2026-09-06T01:57:22Z prerelease=False assets=1
COMMIT aac1a1b 2026-09-10T19:37:00Z :: v0.26.0: release (反思/梦境任务独立成轮根治 0.1.5 工作汇报折叠 + 折叠横条复活 + 导航条隐藏 + list() 双形状 + busy_timeout/热路径 fail-open + 租约轮内心跳)
COMMIT f1e294a 2026-09-10T14:24:05Z :: v0.25.1: release (settings 注册双版本兼容修复)
COMMIT 133e9cb 2026-09-10T14:19:29Z :: fix(settings): 双版本兼容 settings 注册（0.1.2 及以下 / 0.1.3+）
TREE FILECOUNT=68
...
F package-lock.json
F package.json
F scripts/check-fixes.mjs
F scripts/check-lang.mjs
F scripts/diag-dream.mjs
F scripts/hash-check.mjs
F scripts/inspect-client.mjs
F scripts/link-workspace.ps1
F scripts/locate-load.mjs
F scripts/mtime-check.mjs
F scripts/patch-client-banner.mjs
F scripts/stat-lib.mjs
F scripts/verify-client.mjs
F smoke.mjs
F src/bm25.ts
F src/client-delegate-notice.ts
F src/client-delegate-vanish.ts
F src/client-dream-events.ts
F src/client-dream-icon.ts
F src/client-dream-skip.ts
F src/client-fold.ts
F src/client.ts
F src/db.ts
F src/defaults.ts
F src/delegate.ts
F src/dream-signal.ts
F src/dream.ts
F src/index.ts
F src/inject.ts
F src/migrate-v0.ts
F src/migrate.ts
F src/prompt-loader.ts
F src/prompts/README.md
F src/prompts/en/dream-atomic.md
F src/prompts/en/dream-header.md
F src/prompts/en/dream-project-summary.md
F src/prompts/en/dream-topic.md
F src/prompts/en/labels.md
F src/prompts/en/reflect.md
F src/prompts/en/system-guide.md
F src/prompts/en/tools.md
F src/prompts/en/welcome-guide.md
F src/prompts/zh/dream-atomic.md
F src/prompts/zh/dream-header.md
F src/prompts/zh/dream-project-summary.md
F src/prompts/zh/dream-topic.md
F src/prompts/zh/labels.md
F src/prompts/zh/reflect.md
F src/prompts/zh/system-guide.md
F src/prompts/zh/tools.md
F src/prompts/zh/welcome-guide.md
F src/reflect.ts
F src/settings-page.ts
F src/tools.ts
F test.mjs
F tests/client-delegate-notice.mjs
F tests/client-delegate-vanish.mjs
F tests/client-dream-icon.mjs
F tests/client-dream-skip.mjs
F tests/client-fold.mjs
F tsconfig.json
=== README FROM: https://raw.githubusercontent.com/Phant0Meow/dsh-meow-memory/main/README.md (len=10185) ===
# meow-memory 🐱📝
