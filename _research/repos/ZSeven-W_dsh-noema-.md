### REPO: ZSeven-W/dsh-noema  SUBDIR:   BRANCH: 
META default_branch=main stars=128 forks=9 pushed_at=2026-09-11T17:32:05Z created_at=2026-08-14T12:38:51Z license=MIT archived=False open_issues=0 homepage=op.zseven.tech
META description=Noema long-term memory plugin for DSH: durable, inspectable agent memory with recall tools and a settings page.
RELEASE v0.1.0-rc.4 published=2026-09-10T12:51:09Z prerelease=True assets=0
RELEASE v0.1.0-rc.3 published=2026-08-21T15:30:07Z prerelease=True assets=0
RELEASE v0.1.0-rc.2 published=2026-08-19T11:37:22Z prerelease=True assets=7
COMMIT 04598c9 2026-09-11T17:32:00Z :: ci: nightly DSH upgrade preflight via dsh-harbor action
COMMIT 1cd7f18 2026-09-10T12:28:41Z :: fix: boot on DSH 0.1.5 and release 0.1.0-rc.4
COMMIT 9cc3ab1 2026-08-21T14:50:29Z :: docs: list DSH Android among the sibling plugins in every locale
TREE FILECOUNT=72
--- FILES IN SCOPE (max 120) ---
F .github/workflows/check.yml
F .github/workflows/preflight.yml
...
F README.zh.md
F cordis.patch.yml
F docs/images/dsh-noema-logo.png
F docs/images/dsh-noema-overview.png
F npm/darwin-arm64/LICENSE
F npm/darwin-arm64/package.json
F npm/darwin-x64/LICENSE
F npm/darwin-x64/package.json
F npm/linux-arm64/LICENSE
F npm/linux-arm64/package.json
F npm/linux-x64/LICENSE
F npm/linux-x64/package.json
F npm/win32-arm64/LICENSE
F npm/win32-arm64/package.json
F npm/win32-x64/LICENSE
F npm/win32-x64/package.json
F package.json
F platforms.json
F pnpm-lock.yaml
F pnpm-workspace.yaml
F scripts/build-client.mjs
F scripts/check-release-version.mjs
F scripts/pack-package.mjs
F scripts/platforms.mjs
F scripts/publish-release.mjs
F scripts/stage-noema-binary.mjs
F scripts/sync-platform-versions.mjs
F scripts/verify-platform-packages.mjs
F scripts/verify-selective-install.mjs
F src/bundled-binary.ts
F src/client/index.tsx
F src/guidance.ts
F src/import-service.ts
F src/importers.ts
F src/index.ts
F src/mcp-stdio.ts
F src/names.ts
F src/server-manager.ts
F src/settings.ts
F src/status-route.ts
F src/tools.ts
F src/util.ts
F src/version.ts
F tests/bundled-binary.test.mjs
F tests/client-bundle.test.mjs
F tests/e2e-noema.test.mjs
F tests/host-service.test.mjs
F tests/import.test.mjs
F tests/keep-alive.test.mjs
F tests/mcp-stdio.test.mjs
F tsconfig.client.json
F tsconfig.json
=== README FROM: https://raw.githubusercontent.com/ZSeven-W/dsh-noema/main/README.md (len=11849) ===
<p align="center">
