### REPO: vshulcz/deja-vu  SUBDIR: extensions/dsh  BRANCH: main
META ERROR: 远程服务器返回错误: (403) 已禁止。
RELEASE ERROR: 远程服务器返回错误: (403) 已禁止。
COMMIT ERROR: 远程服务器返回错误: (403) 已禁止。
TREE ERROR: 远程服务器返回错误: (403) 已禁止。
=== README FROM: https://raw.githubusercontent.com/vshulcz/deja-vu/main/extensions/dsh/README.md (len=3246) ===
# dsh-deja
