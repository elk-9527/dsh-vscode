### REPO: yihefeikong-rgb/dsh-cc-haha-memory  SUBDIR:   BRANCH: 
META default_branch=main stars=2 forks=0 pushed_at=2026-09-13T22:39:35Z created_at=2026-08-15T17:03:47Z license=MIT archived=False open_issues=0 homepage=
META description=CC-HAHA-inspired persistent memory plugin for DeepSeek Harness (DSH)
RELEASE v0.1.0 published=2026-08-15T17:04:56Z prerelease=False assets=1
COMMIT 049e712 2026-09-13T22:39:30Z :: perf(recall): 索引每会话冻结 + 新增 quiet 档(relevantBodiesEnabled)
COMMIT 8dcf26f 2026-09-13T22:27:35Z :: fix(client): 收回仅存在于安装副本的深浅主题适配源码
COMMIT 77e7c95 2026-09-13T22:22:20Z :: fix: 修复 9 项缺陷并对齐上游 cc-haha 保真度
TREE FILECOUNT=32
...
F client/src/Panel.tsx
F client/src/index.tsx
F cordis.patch.yml
F lib/client.js
F lib/client.js.map
F lib/index.js
...
F src/store.ts
F src/tools.ts
F tests/api.test.mjs
F tests/import.test.mjs
F tests/recall.test.mjs
F tests/recorder.test.mjs
F tests/scope.test.mjs
F tests/store.test.mjs
F tests/tools.test.mjs
=== README FROM: https://raw.githubusercontent.com/yihefeikong-rgb/dsh-cc-haha-memory/main/README.md (len=4606) ===
# DSH CC-HAHA Memory
