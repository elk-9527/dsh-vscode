### REPO: Yiipu/dsh-agentmemory  SUBDIR:   BRANCH: 
META default_branch=main stars=4 forks=0 pushed_at=2026-09-04T08:08:34Z created_at=2026-08-15T09:41:52Z license=MIT archived=True open_issues=0 homepage=
META description=a DSH (DeepSeek Harness) Cordis plugin that bridges a session's activity into agentmemory, a local, self-hosted memory daemon.
RELEASE none
COMMIT 335bb82 2026-09-04T08:08:34Z :: docs: 废弃插件并完善文档 (#3)
COMMIT 43b06b1 2026-08-25T12:13:10Z :: fix: 兼容 ContentBlock[] 摘要并引入运行时配置 (#2)
COMMIT 78f7d0d 2026-08-25T10:45:25Z :: Merge pull request #1 from Yiipu/trae/agent-zkz9WO
TREE FILECOUNT=13
...
F README.md
F README.zh.md
F cordis-row.example.yml
F cordis.patch.yml
F index.d.ts
F index.js
F package.json
F scripts/boot-check.mjs
F scripts/cleanup-smoke-sessions.mjs
F test/smoke.mjs
=== README FROM: https://raw.githubusercontent.com/Yiipu/dsh-agentmemory/main/README.md (len=19472) ===
# dsh-agentmemory
