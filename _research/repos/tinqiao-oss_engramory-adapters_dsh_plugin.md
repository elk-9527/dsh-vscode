### REPO: tinqiao-oss/engramory  SUBDIR: adapters/dsh/plugin  BRANCH: master
META default_branch=master stars=189 forks=12 pushed_at=2026-09-08T02:33:25Z created_at=2026-06-13T14:15:28Z license=MIT archived=False open_issues=1 homepage=
META description=A portable memory protocol for AI agents — load it as standing rules; a curation discipline + reference spec + optional cap hook.
RELEASE v0.11.0 published=2026-09-08T02:34:04Z prerelease=False assets=0
RELEASE v0.10.0 published=2026-08-20T07:30:00Z prerelease=False assets=0
RELEASE v0.9.0 published=2026-08-19T14:21:07Z prerelease=False assets=0
COMMIT 33f1aa8 2026-09-08T02:19:14Z :: docs: carry 0.11.0 into both Status lines, and mirror the trace note in zh-CN
COMMIT bf0fdaa 2026-09-08T02:00:29Z :: feat(tools): a store of conclusions had no way back to the evidence
COMMIT 1bc98e3 2026-08-31T11:30:32Z :: fix(protocol): "at the start of a task" had no lower bound, so a greeting was a task (#19)
TREE FILECOUNT=55
--- FILES IN SCOPE (max 120) ---
F adapters/dsh/plugin/LICENSE
F adapters/dsh/plugin/README.md
F adapters/dsh/plugin/README.zh-CN.md
F adapters/dsh/plugin/cordis.patch.yml
F adapters/dsh/plugin/index.js
F adapters/dsh/plugin/package.json
F adapters/dsh/plugin/test.js
=== README FROM: https://raw.githubusercontent.com/tinqiao-oss/engramory/master/adapters/dsh/plugin/README.md (len=7616) ===
